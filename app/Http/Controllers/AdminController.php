...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        // $confirmedPayments = Pembayaran::whereRaw("DATE_FORMAT(periode_pembayaran, '%Y-%m') = ?", [$currentMonth])
        //     ->where('status', 'lunas')
        //     ->count();
        // $confirmedPayments = Pembayaran::status('lunas')->count();
        // $pendingPayments = Pembayaran::whereRaw("DATE_FORMAT(periode_pembayaran, '%Y-%m') = ?", [$currentMonth])
        //     ->where('status', 'belum_lunas')
        //     ->count();
        // $rejectedPayments = Pembayaran::whereRaw("DATE_FORMAT(periode_pembayaran, '%Y-%m') = ?", [$currentMonth])
