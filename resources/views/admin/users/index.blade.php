                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('users.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700">
                                + Tambah Santri
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column">
                                    @csrf
                                    ...
                                    <div class="modal-footer pt-3 space-x-2" id="footerButtons" style="display: none;">
                                        ...
                                        <button type="submit" class="btn btn-primary px-4 py-2">Import</button>
                                    </div>
                                </form>
                            </div>
                        </div>
